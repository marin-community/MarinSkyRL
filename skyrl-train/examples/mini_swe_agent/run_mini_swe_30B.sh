...
uv run --isolated --extra cuda --extra fsdp --extra vllm --with "mini-swe-agent>=1.12.0" --with litellm --env-file examples/mini_swe_agent/.env.miniswe -m examples.mini_swe_agent.main_mini_swe \
