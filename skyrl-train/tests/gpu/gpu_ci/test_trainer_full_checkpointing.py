...
uv run --isolated --group dev --extra deepspeed --extra cuda --extra fsdp --extra vllm pytest tests/gpu/gpu_ci/test_trainer_full_checkpointing.py -m "not megatron"

For Megatron, run:
uv run --isolated --group dev --extra cuda --extra vllm --extra megatron pytest tests/gpu/gpu_ci/test_trainer_full_checkpointing.py -m "megatron"
"""
