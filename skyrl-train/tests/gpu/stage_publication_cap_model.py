"""Stage five byte-pinned east objects for the queue-persistence qualification."""
...
MODEL_ROOT = "s3://marin-us-east-02a/marin/users/ahmad/models/async-rl-qwen3-0.6b/2026.09.08.48/hf"
MODEL_IDENTITY = "users/ahmad/models/async-rl-qwen3-0.6b@2026.09.08.48:8a30d2b5"
...
if __name__ == "__main__":
    ...
    print("CAP8_MODEL_STAGE_PASS " + json.dumps(stage(args.output)), flush=True)
