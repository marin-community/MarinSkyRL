...
from skyrl_train.utils.utils import validate_batch_sizes, resolve_strategy_limited_telemetry
...
def test_default_grug_ppo_train_keeps_query_bias_exact_across_optimizer_steps():
    ...
    cfg = get_default_config()
    resolve_strategy_limited_telemetry(cfg)  # validate_cfg does this in the driver; the worker reads the resolved value
