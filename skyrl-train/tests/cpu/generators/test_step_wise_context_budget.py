...
from skyrl_train.generators.step_wise_generator import StepWiseGenerator, clamp_generation_tokens
...
async def test_step_wise_generation_clamps_final_request_to_tokenized_window(mock_make):
    ...
    generator = StepWiseGenerator(cfg, MagicMock(max_env_workers=0), engine, _tokenizer(), "test-model")
