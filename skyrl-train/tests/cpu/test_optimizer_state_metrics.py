...
def test_pooled_ratio_diagnostics_are_rejected_where_they_cannot_reduce():
    cfg = example_dummy_config()
    cfg.trainer.strategy = "fsdp2"
    cfg.trainer.algorithm.ratio_diagnostics.pooled = True
    with pytest.raises(ValueError, match="ratio_diagnostics.pooled"):
        validate_cfg(cfg)
