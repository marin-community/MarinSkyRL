...
To enable soft overlong punishment, you can create a custom trainer class and override the ``RayPPOTrainer`` ``postprocess_trajectory_batch`` method to additionally apply soft overlong punishment to rewards.
