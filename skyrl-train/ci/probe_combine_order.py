...
For each row distribution it reports
  ...
  1. the fraction of output elements whose four bf16 addends span more than 14 binades. Only these
     elements can have an order-dependent float32 sum, and some of them still do not:
     [2**24, 2**24, 1, 1] spans 24 binades and sums to 2**25 in every order;
