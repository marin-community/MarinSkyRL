...
class InferenceEngineOutput(TypedDict):
    ...
    # Diagnostic only: every input position that predicted a generated token,
    # including prompt positions. Never used by the regular trajectory path.
    all_routed_experts: NotRequired[List[List[List[List[int]]]]]
