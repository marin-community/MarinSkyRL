...
class MegatronTrainTimings:
    """Accumulate worker-local host wall time per pipeline phase.

    Adds no CUDA synchronization or pipeline barrier. The update's final distributed
    barrier bounds the total; each phase measures host-side dispatch and blocking time.
    """
