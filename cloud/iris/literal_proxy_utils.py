...
def maybe_serve_literal_proxy(
    ...
    *,
    ...
    # Publish the LOCAL literal-log path so the in-loop RL glue (the CLI-agent literal
    # bridge, terminal_bench_generator._maybe_correlate_cli_rollout_details) can
