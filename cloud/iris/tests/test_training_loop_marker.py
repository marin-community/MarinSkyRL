"""The training loop a launched entrypoint runs, as stamped on its telemetry."""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # The launcher's placement override is applied after the YAML, so it decides the loop.
        (RLEntrypoint.TERMINAL_BENCH, COLOCATED, ("++trainer.placement.colocate_all=false",), TrainingLoop.ASYNC),
        (RLEntrypoint.TERMINAL_BENCH, SPLIT, ("trainer.placement.colocate_all=true",), TrainingLoop.SYNC),
