...
from cloud.iris.ray_storage import DEFAULT_RAY_SPILL_DIR  # noqa: E402
...
def test_worker_uses_launcher_owned_local_spill_directory(monkeypatch):
    ...
    controller.ray_start_worker("10.0.0.1", 6379, "10.0.0.2", local_spill_dir=DEFAULT_RAY_SPILL_DIR)
