...
def save(result: dict) -> None:
    ...
    (directory / f"{result['role']}{suffix}-result.json").write_text(json.dumps(result, indent=2, sort_keys=True) + "\n")
...
def main() -> None:
    ...
    try:
        ...
        dist.init_process_group(
            "nccl", init_method=f"tcp://{host}:{args.port}", rank=rank, world_size=args.world_size,
        ...
        for repeat in range(args.repeats):
            ...
            result["samples"].append({
                ...
                "receiver_sha256": gathered[0], "sender_sha256": gathered[args.source_rank],
