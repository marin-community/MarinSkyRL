...
RESULT=s3://marin-us-east-02a/iris/grug-training-perf-gap/20260803/divergence-closeout-2dd905e/preflight-paired-s1.json
RENDEZVOUS=s3://marin-us-east-02a/iris/grug-training-perf-gap/20260803/rendezvous/divergence-closeout-2dd905e-preflight-paired-s1
PY=/opt/openthoughts/envs/rl/bin/python
DRIVER=/opt/skyrl/skyrl-train/scripts/grug_fixed_replay_benchmark.py
WORKER=/opt/skyrl/skyrl-train/skyrl_train/workers/fsdp/fsdp_worker.py
CONTROLLER=/tmp/msrl/cloud/iris/start_rl_iris_controller.py

export HF_HOME=/hf/cache
export HF_HUB_OFFLINE=1
export TRANSFORMERS_OFFLINE=1
export NCCL_SOCKET_IFNAME='^ibs,ibp,lo,docker,veth,cilium,lxc'
export PYTHONPATH=/tmp/msrl:/opt/skyrl/skyrl-train
