...
world_size="${1:?usage: run_grug_h100.sh WORLD_SIZE SHAPE}"
shape="${2:?usage: run_grug_h100.sh WORLD_SIZE SHAPE}"
...
common_args=(--world-size "$world_size" --shape "$shape" --steps 1)
