...
from marinskyrl.runtime_environment import ENV_VAR_SPECS  # noqa: E402

MANAGER_PATH = Path("marinskyrl/runtime_environment.py")
...
def main() -> int:
    ...
    if not errors:
        return 0
    print("Environment-variable definitions violate marinskyrl.runtime_environment ownership:")
    for error in errors:
        print(f"  {error}")
    return 1
